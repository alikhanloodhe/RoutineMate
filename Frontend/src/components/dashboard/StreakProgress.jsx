...
const StreakProgress = ({ routineStreak, taskStreak, habitStreak }) => {
  const streaks = [
    {
      type: 'Routines',
      current: routineStreak.current,
      longest: routineStreak.longest,
    ...
    {
      type: 'Tasks',
      current: taskStreak.current,
      longest: taskStreak.longest,
    ...
    {
      type: 'Habits',
      current: habitStreak.current,
      longest: habitStreak.longest,
